...
// CONCATENATED MODULE: ./dist/call-x.esm.js
...
var call_x_esm_ERROR_MESSAGE = ' is not a function';
var call_x_esm_funcType = '[object Function]';

var call_x_esm_assertIsFunction = function assertIsFunction(value) {
  if (typeof value !== 'function' && toStringTag(value) !== call_x_esm_funcType) {
    throw new $TypeError(value + call_x_esm_ERROR_MESSAGE);
  }

  return value;
};

var call_x_esm_pushAll = function pushAll(arrayLike) {
  var target = [];
...
var call = function call(F, V) {
  /* eslint-disable-next-line prefer-rest-params */
  return $apply(call_x_esm_assertIsFunction(F), V, call_x_esm_pushAll(arguments[2]));
};

/* harmony default export */ var call_x_esm = __webpack_exports__["default"] = (call);
...
//# sourceMappingURL=call-x.js.map